            ...
            <div class="dropdown">
                ...
                Inputan
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="inputan/input-distributor.php">Input Distributor</a></li>
                ...
                Tambah
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="tambah/input-pasok-buku.php">Input Pasok Buku</a></li>
                    </ul>
                <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                Laporan
                </button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        ...
                        <li><a class="dropdown-item" href="laporan/buku-tidak-pernah-terjual.php">Buku Yang Tidak Pernah Terjual</a></li>
